...
## Happy Hour at Miss B's

Miss B's runs happy hour Monday through Friday from 3 to 5pm at the full open-air bar and patio. It doesn't run on weekends, so plan a weekday afternoon if that's the draw. Check [the FAQ](/faq) for current details.
